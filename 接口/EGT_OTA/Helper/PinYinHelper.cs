    ...
    public class PinYinHelper
    {
        ...
        public static Hashtable CHSPhraseSpecial
        {
            get
            {
                ...
                {
                    Hashtable hashtable1 = _phraseSpecial;
                    hashtable = new Hashtable();
                    hashtable.Add("重庆", "Chong Qing");
                    hashtable.Add("深圳", "Shen Zhen");
                    hashtable.Add("什么", "Shen Me");
                }
                return (_phraseSpecial = hashtable);
            }
            set
            {
                _phraseSpecial = value;
            }
        }
    }
}
